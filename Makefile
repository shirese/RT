...
SRC_GEOS		=	cone.c cone2.c cone3.c cylinder.c disk.c geo.c parahyp.c plane.c pipe.c sphere.c
...
SRC_RENDER		=	interface.c ray.c raytracer.c raypath.c render_thr.c
