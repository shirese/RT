...
void			parse_geo_attributes(char **line, char *v, t_geo *g, int *fd);
void			parse_geo_attributes_2(char **line, char *v, t_geo *g, int *fd);
...
int				set_borns(double to, double dn, double *b_sup, double *b_inf);
